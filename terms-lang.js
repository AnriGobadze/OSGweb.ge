document.addEventListener('DOMContentLoaded', () => {
    const translations = {
        ge: {
            ...
            clause1Body: "ვებსაიტის კოდი, დიზაინი და ყველა მასალა წარმოადგენს შემსრულებლის (OSG) საკუთრებას და კლიენტის მფლობელობაში სრულად გადადის მხოლოდ მომსახურების სრული ღირებულების დაფარვის შემდეგ: ერთჯერადი გადახდის შემთხვევაში მეორე 50%-ის დაფარვისთანავე, ხოლო ყოველთვიური (Subscription) მოდელისას მე-13 გადასახადის დაფარვის შემდეგ.",

            clause2Title: "გადახდის მოდელები და სავალდებულო პერიოდი",
            clause2Body: "თანამშრომლობა ხორციელდება ორთაგან ერთ-ერთი შეთანხმებული მოდელით:<br><br>ერთჯერადი გადახდა (50/50): 50% იფარება სამუშაოს დაწყებამდე (ავანსი), ხოლო დარჩენილი 50% პროექტის დასრულებისთანავე, საიტის ინტერნეტში გაშვებამდე (Live).<br><br>ყოველთვიური მოდელი (Subscription): ხელშეკრულება იდება მინიმუმ 13 თვის ვადით. კლიენტის მიერ ხელშეკრულების ვადაზე ადრე შეწყვეტის შემთხვევაში, შესრულებული სამუშაოს საკომპენსაციოდ გამოიყენება ფიქსირებული ჯარიმა.",

            clause3Title: "მომსახურების შეჩერება და გათიშვა",
            clause3Body: "ყოველთვიური გადასახადის 5 კალენდარული დღით გადაცილების, ან ერთჯერადი გადახდისას მეორე 50%-ის დროულად გადაუხდელობის შემთხვევაში, შემსრულებელს (OSG) აქვს უფლება გაფრთხილების გარეშე შეაჩეროს სამუშაოები ან სრულად გათიშოს ვებსაიტი ინტერნეტ სივრციდან დავალიანების სრულად დაფარვამდე.",
            ...
            clause5Body: "მომსახურება მოიცავს მხოლოდ თავდაპირველად შეთანხმებულ ფუნქციონალსა და დიზაინს. პროექტის დამტკიცების შემდეგ ნებისმიერი ახალი ფუნქციონალის ან სტრუქტურული ცვლილების დამატება წარმოადგენს ცალკე მომსახურებას და ექვემდებარება დამატებით საფასურს.",

            clause6Title: "თანხის დაბრუნების პოლიტიკა",
            clause6Body: "სამუშაოს დაწყების (დიზაინის/კოდის შემუშავების) შემდეგ კლიენტის მიერ გადახდილი პირველადი 50%-იანი ავანსი ან ყოველთვიური შენატანი უკან დაბრუნებას არ ექვემდებარება, რადგან ის ფარავს უკვე გაწეულ სამუშაო საათებსა და რესურსს.",
        ...
        en: {
            ...
            clause1Body: "The website's code, design, and all materials are the property of the Contractor (OSG) and are transferred in full to the Client's ownership only after the total cost of the service has been paid in full: for the one-time payment model, immediately upon payment of the remaining 50%; for the monthly (Subscription) model, after payment of the 13th installment.",

            clause2Title: "Payment Models and Mandatory Term",
            clause2Body: "Cooperation is carried out under one of two agreed models:<br><br>One-time payment (50/50): 50% is paid before work begins (advance), and the remaining 50% immediately upon completion of the project, before the website goes live.<br><br>Monthly model (Subscription): the agreement is concluded for a minimum term of 13 months. If the Client terminates the agreement early, a fixed penalty applies to compensate for the work already performed.",

            clause3Title: "Suspension and Disconnection of Service",
            clause3Body: "If a monthly payment is delayed by 5 calendar days, or if the remaining 50% under the one-time payment model is not paid on time, the Contractor (OSG) has the right, without prior notice, to suspend work or take the website fully offline until the outstanding balance is paid in full.",
            ...
            clause5Body: "The service covers only the functionality and design initially agreed upon. After the project has been approved, adding any new functionality or making structural changes constitutes a separate service and is subject to an additional fee.",

            clause6Title: "Refund Policy",
            clause6Body: "Once work has begun (design/code development), the initial 50% advance or a monthly installment paid by the Client is non-refundable, as it covers work hours and resources already spent.",
        ...
        ru: {
            ...
            clause1Body: "Код сайта, дизайн и все материалы являются собственностью Исполнителя (OSG) и переходят в полную собственность Клиента только после полной оплаты стоимости услуги: при единоразовой оплате — сразу после внесения оставшихся 50%, а при ежемесячной модели (Subscription) — после оплаты 13-го платежа.",

            clause2Title: "Модели оплаты и обязательный срок",
            clause2Body: "Сотрудничество осуществляется по одной из двух согласованных моделей:<br><br>Единоразовая оплата (50/50): 50% оплачивается до начала работ (предоплата), а оставшиеся 50% — сразу после завершения проекта, до запуска сайта в интернете (Live).<br><br>Ежемесячная модель (Subscription): договор заключается на минимальный срок 13 месяцев. В случае досрочного расторжения договора Клиентом в качестве компенсации за выполненную работу применяется фиксированный штраф.",

            clause3Title: "Приостановка и отключение услуг",
            clause3Body: "В случае просрочки ежемесячного платежа на 5 календарных дней, либо несвоевременной оплаты оставшихся 50% при единоразовой модели оплаты, Исполнитель (OSG) имеет право без предупреждения приостановить работы или полностью отключить сайт из интернет-пространства до полного погашения задолженности.",
            ...
            clause5Body: "Услуга включает только изначально согласованный функционал и дизайн. После утверждения проекта добавление любого нового функционала или структурных изменений считается отдельной услугой и подлежит дополнительной оплате.",

            clause6Title: "Политика возврата средств",
            clause6Body: "После начала работы (разработки дизайна/кода) первоначальный 50%-ный аванс или ежемесячный платёж, внесённый Клиентом, не подлежит возврату, так как покрывает уже затраченные рабочие часы и ресурсы.",
