...
const displayReviews = (reviews = []) => {
    ...
    // ================================
    SpaNavigator.init();
    setLanguage(localStorage.getItem('userLanguage') || 'ge');
});