document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        ru: { pageTitle: "OSGWeb.ge - Веб-сайты, развивающие ваш бизнес", pageDescription: "Веб-сайты, которые работают на вас", navServices: "Услуги", navPortfolio: "Портфолио", navTestimonials: "Отзывы", navContact: "Контакты", navReview: "Оставить отзыв", heroTitle: "Ваш бизнес,<br><span class='gradient-text'>в цифре</span>", heroSubtitle: "Веб-сайты, которые работают на вас", heroButton: "Начать проект", servicesTitle: "Наша цель — ваш успех", service1Title: "Дизайн", service1Desc: "Технически грамотного сайта недостаточно — первое впечатление визуальное. Дизайн должен быть современным, понятным и соответствовать бренду.", service2Title: "Безопасность", service2Desc: "Доверие пользователей начинается с безопасности. Современные технологии защищают от взломов, утечек и других угроз.", service3Title: "Управление", service3Desc: "Интуитивная система позволяет легко редактировать тексты, добавлять изображения и адаптировать сайт под свои нужды — без навыков программирования.", portfolioTitle: "Избранные проекты", portfolio1Title: "'The Golden Fork' — сайт ресторана", portfolio2Title: "'The Gents Chair' — брендинг барбершопа", portfolio3Title: "'Aroma Collective' — онлайн-заказ для кафе", testimonialsTitle: "Отзывы и мнения", contactTitle: "Связаться с нами", contactInfoTitle: "Контактная информация", contactInfoDesc: "Есть проект или вопрос? Напишите нам, позвоните или заполните форму.", contactInfoLocation: "Тбилиси, Грузия", formNamePlaceholder: "Ваше имя", formEmailPlaceholder: "Ваш email", formMessagePlaceholder: "Ваше сообщение", formSendButton: "Отправить", footerAbout: "Инновационный цифровой опыт для успеха бренда.", footerLinksTitle: "Быстрые ссылки", footerContactTitle: "Контакты", footerSocialTitle: "Мы в соцсетях", footerCopyright: "© 2024 OSGWeb.ge. Все права защищены.", reviewPageTitle: "Оставить отзыв", reviewPageSubtitle: "Ваш отзыв помогает нам становиться лучше.", formFullNamePlaceholder: "Полное имя", formCompanyPlaceholder: "Компания (необязательно)", formWebsitePlaceholder: "Сайт, который мы сделали для вас", reviewFormRatingLabel: "Ваша оценка:", reviewFormMessagePlaceholder: "Напишите ваш отзыв здесь...", reviewFormSubmitButton: "Отправить отзыв", reviewSuccessTitle: "Спасибо!", reviewSuccessMessage: "Ваш отзыв отправлен и будет опубликован после подтверждения проекта.", noReviewsMessage: "Пока отзывов нет. Будьте первым!", reviewPendingTitle: "Отзыв на проверке", reviewPendingMessage: "Ваш отзыв будет опубликован после подтверждения проекта." }
    };
