document.addEventListener('DOMContentLoaded', () => {
    ...
    const SpaNavigator = {
        elements: {
            navLinks: null, pageViews: null, mainContentView: null, body: document.body
        },
        scrollObserver: null,

        init() {
            this.elements.navLinks = document.querySelectorAll('.nav-link');
            this.elements.pageViews = document.querySelectorAll('.page-view');
            this.elements.mainContentView = document.getElementById('main-content-view');
        ...
        _bindEvents() {
            document.addEventListener('click', (e) => {
                ...
                const isMobileNavLink = e.target.closest('.mobile-nav-links');
                if (isMobileNavLink && this.elements.body.classList.contains('mobile-nav-is-open')) {
                    closeMobileMenu();
                }
    ...
    // ================================
    // MOBILE NAVIGATION (CORRECTED & CENTRALIZED)
    // ================================
    ...
    // ================================
    const translations = {
        en: { pageTitle: "OSGWeb.ge - Websites That Grow Your Business", pageDescription: "Websites That Work For You", navServices: "Services", navPortfolio: "Portfolio", navTestimonials: "Testimonials", navContact: "Contact", navReview: "Leave a Review", heroTitle: "Your Business,<br><span class='gradient-text'>Digitally</span>", heroSubtitle: "Websites That Work For You", heroButton: "Start a Project", servicesTitle: "Our Goal Is Your Success", service1Title: "Design", service1Desc: "A technically sound website is not enough — the visual impression decides whether the user stays. The design should be modern, easy to understand, and tailored to the brand.", service2Title: "Security", service2Desc: "User trust begins with website security. Modern protection mechanisms ensure defense against hacking attacks, data leaks, and other threats.", service3Title: "Easy Management", service3Desc: "An intuitive system lets you easily change texts, add images, and customize the site to your needs — without coding knowledge.", portfolioTitle: "Featured Works", portfolio1Title: "'The Golden Fork' - Restaurant Website", portfolio2Title: "'The Gents Chair' - Barbershop Branding", portfolio3Title: "'Aroma Collective' - Cafe Online Ordering", testimonialsTitle: "Reviews and Testimonials", contactTitle: "Contact Us", contactInfoTitle: "Contact Information", contactInfoDesc: "Have a project or question? Write to us, call us, or fill out the form.", contactInfoLocation: "Tbilisi, Georgia", formNamePlaceholder: "Your Name", formEmailPlaceholder: "Your Email", formMessagePlaceholder: "Your Message", formSendButton: "Send", footerAbout: "Innovative digital experience for brand success.", footerLinksTitle: "Quick Links", footerContactTitle: "Contact Us", footerSocialTitle: "Follow Us", footerCopyright: "© 2024 OSGWeb.ge. All rights reserved.", reviewPageTitle: "Leave a Review", reviewPageSubtitle: "Your feedback helps us become even better.", formFullNamePlaceholder: "Full Name", formCompanyPlaceholder: "Company (Optional)", formWebsitePlaceholder: "Website We Built For You", reviewFormRatingLabel: "Your Rating:", reviewFormMessagePlaceholder: "Write your review here...", reviewFormSubmitButton: "Submit Review", reviewSuccessTitle: "Thank You!", reviewSuccessMessage: "Your review has been submitted and will be published after we confirm your project.", noReviewsMessage: "No reviews yet, Be the first to leave a review!", reviewPendingTitle: "Review Pending", reviewPendingMessage: "Your review will be published after we confirm your project.", },
        ka: { pageTitle: "OSGWeb.ge - ვებსაიტები, რომელიც ბიზნესს ზრდის", pageDescription: "ვებსაიტები, რომლებიც მუშაობენ თქვენთვის", navServices: "სერვისები", navPortfolio: "პორტფოლიო", navTestimonials: "შეფასებები", navContact: "კონტაქტი", navReview: "შეფასების დატოვება", heroTitle: "შენი ბიზნესი,<br><span class='gradient-text'>ციფრულად</span>", heroSubtitle: "ვებსაიტები, რომლებიც მუშაობენ თქვენთვის", heroButton: "პროექტის დაწყება", servicesTitle: "ჩვენი მიზანია შენი წარმატება", service1Title: "დიზაინი", service1Desc: "ტექნიკურად გამართული საიტი საკმარისი არაა — ვიზუალური შთაბეჭდილება გადაწყვიტავს, დარჩება თუ არა მომხმარებელი. დიზაინი უნდა იყოს თანამედროვე, მარტივად აღსაქმელი და ბრენდზე მორგებული.", service2Title: "უსაფრთხოება", service2Desc: "მომხმარებლის ნდობა იწყება საიტის უსაფრთხოებით. თანამედროვე დაცვით მექანიზმებს უზრუნველყოფს ჰაკერული თავდასხმების, მონაცემთა გაჟონვის და სხვა საფრთხეებისგან დაცვას.", service3Desc: "ინტუიციური სისტემა საშუალებას გაძლევთ მარტივად შეცვალოთ ტექსტები, დაამატოთ სურათები და მოარგოთ საიტი თქვენს საჭიროებებს — კოდის ცოდნის გარეშე.", portfolioTitle: "გამორჩეული ნამუშევრები", portfolio1Title: "'The Golden Fork' - რესტორნის ვებსაიტი", portfolio2Title: "'The Gents Chair' - ბარბერშოპის ბრენდინგი", portfolio3Title: "'Aroma Collective' - კაფეს ონლაინ შეკვეთა", testimonialsTitle: "მიმოხილვები და შეფასებები", contactTitle: "დაგვიკავშირდით", contactInfoTitle: "საკონტაქტო ინფორმაცია", contactInfoDesc: "გაქვთ პროექტი ან შეკითხვა? მოგვწერეთ, დაგვირეკეთ, ან შეავსეთ ფორმა.", contactInfoLocation: "თბილისი, საქართველო", formNamePlaceholder: "თქვენი სახელი", formEmailPlaceholder: "თქვენი ელ. ფოსტა", formMessagePlaceholder: "თქვენი შეტყობინება", formSendButton: "გაგზავნა", footerAbout: "ინოვაციური ციფრული გამოცდილება ბრენდების წარმატებისთვის.", footerLinksTitle: "სწრაფი ბმულები", footerContactTitle: "დაგვიკავშირდით", footerSocialTitle: "გამოგვყევით", footerCopyright: "© 2024 OSGWeb.ge. ყველა უფლება დაცულია.", reviewPageTitle: "შეფასების დატოვება", reviewPageSubtitle: "თქვენი შეფასება გვეხმარება გავხდეთ უკეთესები.", formFullNamePlaceholder: "სრული სახელი", formCompanyPlaceholder: "კომპანია (სურვილისამებრ)", formWebsitePlaceholder: "ვებსაიტი რომელიც თქვენთვის ავაწყვეთ", reviewFormRatingLabel: "თქვენი შეფასება:", reviewFormMessagePlaceholder: "დაწერეთ თქვენი შეფასება აქ...", reviewFormSubmitButton: "შეფასების გაგზავნა", reviewSuccessTitle: "მადლობა!", reviewSuccessMessage: "თქვენი შეფასება გაგზავნილია და პროექტის დადასტურებისთანავე გამოქვეყნდება.", noReviewsMessage: "შეფასებები არ არის.", reviewPendingTitle: "შეფასება მიღებულია", reviewPendingMessage: "თქვენი შეფასება გამოქვეყნდება პროექტის დადასტურებისთანავე.", },
                ru: {
            pageTitle: "OSGWeb.ge - Веб-сайты, развивающие ваш бизнес",
            pageDescription: "Веб-сайты, которые работают на вас",
            navServices: "Услуги",
            navPortfolio: "Портфолио",
            navTestimonials: "Отзывы",
            navContact: "Контакты",
            navReview: "Оставить отзыв",
            heroTitle: "Ваш бизнес,<br><span class='gradient-text'>в цифре</span>",
            heroSubtitle: "Веб-сайты, которые работают на вас",
            heroButton: "Начать проект",
            servicesTitle: "Наша цель — ваш успех",
            service1Title: "Дизайн",
            service1Desc: "Технически грамотного сайта недостаточно — первое впечатление визуальное. Дизайн должен быть современным, понятным и соответствовать бренду.",
            service2Title: "Безопасность",
            service2Desc: "Доверие пользователей начинается с безопасности. Современные технологии защищают от взломов, утечек и других угроз.",
            service3Title: "Управление",
            service3Desc: "Интуитивная система позволяет легко редактировать тексты, добавлять изображения и адаптировать сайт под свои нужды — без навыков программирования.",
            portfolioTitle: "Избранные проекты",
            portfolio1Title: "'The Golden Fork' — сайт ресторана",
            portfolio2Title: "'The Gents Chair' — брендинг барбершопа",
            portfolio3Title: "'Aroma Collective' — онлайн-заказ для кафе",
            testimonialsTitle: "Отзывы и мнения",
            ...
            footerCopyright: "© 2024 OSGWeb.ge. Все права защищены.",
            reviewPageTitle: "Оставить отзыв",
            reviewPageSubtitle: "Ваш отзыв помогает нам становиться лучше.",
            formFullNamePlaceholder: "Полное имя",
            formCompanyPlaceholder: "Компания (необязательно)",
            formWebsitePlaceholder: "Сайт, который мы сделали для вас",
            reviewFormRatingLabel: "Ваша оценка:",
            reviewFormMessagePlaceholder: "Напишите ваш отзыв здесь...",
            reviewFormSubmitButton: "Отправить отзыв",
            reviewSuccessTitle: "Спасибо!",
            reviewSuccessMessage: "Ваш отзыв отправлен и будет опубликован после подтверждения проекта.",
            noReviewsMessage: "Пока отзывов нет. Будьте первым!",
            reviewPendingTitle: "Отзыв на проверке",
            reviewPendingMessage: "Ваш отзыв будет опубликован после подтверждения проекта."
        }
    };
    ...
    document.getElementById('mobile-nav-panel')?.addEventListener('click', (e) => {
        ...
        if (langButton) {
            ...
            if (lang) {
                setLanguage(lang);
                closeMobileMenu(); // CORRECTED: Use the central function to close
            }
        }
    });
    ...
    const displayReviews = (reviews = []) => {
        ...
        reviewListContainer.innerHTML = reviews.length === 0
            ? `<div class="no-reviews-message"><p>${translations[currentLanguage].noReviewsMessage}</p></div>`
            : reviews.map(r => '...').join(''); // Placeholder for actual review mapping
    };
